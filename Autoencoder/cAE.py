...
#-----------------------------------#
if(len(sys.argv) < 2):
    ARG_PATH   = "/home/wilfried/git/NT_structure/Autoencoder/data/Ethiopia"#"./data/Carrots"
    ARG_EPOCHS = 10
    ARG_CODE   = 10
    ARG_X      = 64
    ARG_Y      = 64
...
#if(image_size_X==64):
code3 = Dense(2048,        activation ='relu',name='Code_post')(code2)
reshapeCode = Reshape((2,2,512))(code3)
#else:
#    code3 = Dense(10752,        activation ='relu',name='Code_post')(code2)
